...
from ecommerceapp.models import Categories,SubCategories,CustomUser,MerchantUser,Products,ProductAbout,ProductDetails,ProductMedia,ProductTransaction,ProductTags,StaffUser,CustomerUser
...
class MerchantUserListView(ListView):
    ...
    # def get_context_data(self, **kwargs): 
    #     context= super(MerchantUserListView).get_context_data(**kwargs)
    #     context["filter"]=self.request.GET.get("filter","")
    #     context["orderby"]=self.request.GET.get("orderby","id")
    #     context["all_tables_fields"]=MerchantUser._meta.get_fields()
    #     return context
...
class ProductView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        product=Products(product_name=product_name,in_stock_total=in_stock_total,url_slug=url_slug,brand=brand,Subcategories_id=subcat_obj,product_description=product_description,product_max_price=product_max_price,product_discount_price=product_discount_price,added_by_merchant=merchant_user_obj)
        product.save()
        ...
        j=0
        for title_title in title_details_list:
...
class ProductAddStocks(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        # return HttpResponseRedirect(reverse("product_add_stocks",kwargs={"product-id":product_id}))
